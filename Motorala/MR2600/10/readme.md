...
![image-20220522105332685](img/image-20220522105332685.png)

By/SaveVLANParams/VLANIDInfoLists/VLANID: 0 / VID to v18 parameters of access to content

![image-20220522105354047](img/image-20220522105354047.png)

Format v18 into v54 with the snprintf function, setting v54 to the value of WAN_WAN0_IFNAME

![image-20220522105417369](img/image-20220522105417369.png)

Rc program transmits the content obtained by nvram_safe_get function to V6, formats V6 into V43 by snprintf function, and finally executes the content in V43 by twsysytem, which has command injection vulnerability
